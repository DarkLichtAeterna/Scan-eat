...
const CACHE = 'scann-eat-shell-1a3c9f1';
const SHELL = [
  '/',
  '/index.html',
  '/app.js',
  ...
  '/core/nutrition-fields.js',
  '/core/user-content-checks.js',
  // /data/
  '/data/queue-store.js',
  ...
  '/features/portion-panel.js',
  '/features/scan-history-ui.js',
  '/features/update-checker.js',
];
